...
var ChartCanvas = function (_Component) {
	...
	_createClass(ChartCanvas, [{
		...
		key: "handleDragStart",
		value: function handleDragStart(_ref4, e) {
			var startPos = _ref4.startPos;


			if (e && e.path) {
				dispatch.call("handleDragStart", this, { _ref3: _ref3, e: e });
			}
		...
		key: "handleDrag",
		value: function handleDrag(_ref5, e) {
			var _this7 = this;

			var startPos = _ref5.startPos,
			    mouseXY = _ref5.mouseXY;
		...
		key: "handleDragEnd",
		value: function handleDragEnd(_ref6, e) {
			var _this8 = this;

			var mouseXY = _ref6.mouseXY;
