...
var ChartCanvas = function (_Component) {
	...
	_createClass(ChartCanvas, [{
		...
		value: function handlePinchZoom(initialPinch, finalPinch, e) {
			...
			//当是真实pad上pinchZoom事件触发时，触发d3-dispatch注册的handlePinchZoom事件，将捕获到的参数分发出去
			if (e && e.path) {
				dispatch.call("handlePinchZoom", this, { initialPinch: initialPinch, finalPinch: finalPinch, e: e });
			}
		...
		value: function handlePinchZoomEnd(initialPinch, e) {
			...
			//当是真实pad上pinchZoomEnd事件触发时，触发d3-dispatch注册的handlePinchZoomEnd事件，将捕获到的参数分发出去

			if (e && e.path) {
				dispatch.call("handlePinchZoomEnd", this, { initialPinch: initialPinch, e: e });
			}
		...
		value: function handleZoom(zoomDirection, mouseXY, e) {
			...
			//当是真实的Zoom(鼠标上下滚动或触摸板开阖)事件触发时，触发d3-dispatch注册的handleZoom事件，将捕获到的参数分发出去
			//需要限定type为wheel类型，主要为了排除键盘事件重复触发
		...
		value: function handlePan(mousePosition, panStartXScale, dxdy, chartsToPan, e) {
			...
			//当是真实的Pan(鼠标或触摸板左右拖动)事件触发时，触发d3-dispatch注册的handlePan事件，将捕获到的参数分发出去
			//为了区分真实事件与模拟事件的不同，在e中加入triggered属性标识为模拟事件
			//限定类型为keydown，主要为了排除键盘事件重复触发
		...
		value: function handlePanEnd(mousePosition, panStartXScale, dxdy, chartsToPan, e) {
			...
			//当是真实的PanEnd(鼠标或触摸板左右拖动)事件触发时，触发d3-dispatch注册的handlePanEnd事件，将捕获到的参数分发出去
			//为了区分真实事件与模拟事件的不同，在e中加入triggered属性标识为模拟事件
			if (!(e && e.triggered)) {
				dispatch.call("handlePanEnd", this, { mousePosition: mousePosition, panStartXScale: panStartXScale, dxdy: dxdy, chartsToPan: chartsToPan, e: e });
			}
		...
		value: function handleMouseDown(mousePosition, currentCharts, e) {
			...
			//当是真实的MouseDown事件触发时，触发d3-dispatch注册的handleMouseDown事件，将捕获到的参数分发出去
			if (e && e.path) {
				dispatch.call("handleMouseDown", this, { mousePosition: mousePosition, currentCharts: currentCharts, e: e });
			}
		...
		value: function handleMouseEnter(e) {
			...
			//当是真实的MouseEnter事件触发时，触发d3-dispatch注册的handleMouseEnter事件，将捕获到的参数分发出去
			if (e && e.path) {
				dispatch.call("handleMouseEnter", this, { e: e });
			}
		...
		value: function handleMouseMove(mouseXY, inputType, e) {
			...
			//当是真实的MouseMove事件触发时，触发d3-dispatch注册的handleMouseMove事件，将捕获到的参数分发出去
			if (e && e.path) {
				dispatch.call("handleMouseMove", this, { mouseXY: mouseXY, inputType: inputType, e: e });
			}
		...
		value: function handleMouseLeave(e) {
			...
			//当是真实的MouseLeave事件触发时，触发d3-dispatch注册的handleMouseLeave事件，将捕获到的参数分发出去
			if (!e) {
				dispatch.call("handleMouseLeave", this, { e: e });
			}
		...
		value: function handleDragStart(_ref3, e) {
			...
			//当是真实的DragStart事件触发时，触发d3-dispatch注册的handleDragStart事件，将捕获到的参数分发出去
			if (e && e.path) {
				dispatch.call("handleDragStart", this, { startPos: startPos, e: e });
			}
		...
		value: function handleDrag(_ref4, e) {
			...
			//当是真实的Drag事件触发时，触发d3-dispatch注册的handleDrag事件，将捕获到的参数分发出去
			if (e && e.path) {
				dispatch.call("handleDrag", this, { startPos: startPos, mouseXY: mouseXY }, e);
			}
		...
		value: function handleDragEnd(_ref5, e) {
			...
			//当是真实的DragEnd事件触发时，触发d3-dispatch注册的handleDragEnd事件，将捕获到的参数分发出去
			if (e && e.path) {
				dispatch.call("handleDragEnd", this, { mouseXY: mouseXY }, e);
			}
