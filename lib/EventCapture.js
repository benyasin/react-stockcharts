...
var EventCapture = function (_Component) {
    ...
    _createClass(EventCapture, [{
        ...
        value: function render() {
            ...
            //添加一个固定的class:react-stockcharts-cursor，用来作dom选择器的选取对象

            var className = this.state.cursorOverrideClass != null ? this.state.cursorOverrideClass : !useCrossHairStyleCursor ? "" : this.state.panInProgress ? "react-stockcharts-cursor react-stockcharts-grabbing-cursor" : "react-stockcharts-cursor react-stockcharts-crosshair-cursor";
